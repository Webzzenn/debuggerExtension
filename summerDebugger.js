(function (Scratch) {
  ...
  // Orange accent used throughout the UI
  const ACCENT_COLOR = "#FF7A2F";
    ...
    getInfo() {
      return {
        ...
        blocks: [
          ...
          "---",
          {
            opcode: "ToggleDebugger",
            blockType: Scratch.BlockType.COMMAND,
            text: 'visibility[BOOLEAN]',
            arguments: {
              BOOLEAN: {
    ...
    _createWindow() {
      ...
      const makeTabButton = (label) => {
        ...
        b.addEventListener("mouseover", () => {
          b.style.backgroundColor = `${ACCENT_COLOR}33`;
        });
      ...
      const activateTab = (tabName) => {
        ...
        switch (tabName) {
          case "logs":
            ...
            logsTabButton.style.borderBottom = `2px solid ${ACCENT_COLOR}`;
